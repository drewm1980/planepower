#ifndef __PLANESIMULATORRFRAMEDIRECTCONTROLS__
#define __PLANESIMULATORRFRAMEDIRECTCONTROLS__
...
#include <ocl/OCL.hpp>
#include "model/rk4_rframe_direct_controls.h"
...
namespace OCL
{
    ...
    /// planeSimulatorRframeDirectControls class
    /**
    ...
    */
    class planeSimulatorRframeDirectControls
        : public TaskContext
    {
    protected:
        /*********
    ...
    public:
        planeSimulatorRframeDirectControls(std::string name);

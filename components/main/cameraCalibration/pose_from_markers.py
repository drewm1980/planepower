...
#J = casadi.jacobian(pose_from_markers.outputExpr(),pose_from_markers.inputExpr())
J = casadi.jacobian(pose,markers)
...
#pose_from_markers.generateCode('pose_from_markers.c') #225
#pose_and_covrt_from_markers.generateCode('pose_from_markers.c') #1636
#pose_and_covrtinv_from_markers.generateCode('pose_from_markers.c') #2782
#pose_and_J_from_markers.generateCode('pose_from_markers.c')  # 1348
pose_and_covrt_and_covrtinv_from_markers.generateCode('pose_from_markers.c') #2928
import os
print "Number of lines of C autogenerated C source code:"
os.system('cat pose_from_markers.c | wc -l')

...
PdatC1 = loadtxt('cameras/PC1.dat') # fx fy cx cy
f1 = PdatC1[:2]
c1 = PdatC1[2:]

# Intrinsics for camera 2
PdatC2 = loadtxt('cameras/PC2.dat') # fx fy cx cy
f2 = PdatC2[:2]
c2 = PdatC2[2:]

# Extrinsics
RPC1 = loadtxt('cameras/RPC1.dat') # maps points in camera 1 frame into points in arm frame
RPC2 = loadtxt('cameras/RPC2.dat') # maps points in camera 2 frame into points in arm frame
...
m1_body = loadtxt('./markers/pos_marker_body1.dat')
m2_body = loadtxt('./markers/pos_marker_body2.dat')
m3_body = loadtxt('./markers/pos_marker_body3.dat')

...
//		logger(dynamic_cast<OCL::logging::Category*>(&log4cpp::Category::getInstance("dynamicMHE")))
{
	...
	// XXX Autogenerated code from MHE.cpp START
	this->addProperty("r", acadoVariables.p[0]);
	this->addProperty("mk", acadoVariables.p[1]);
	this->addProperty("g", acadoVariables.p[2]);
	this->addProperty("rho", acadoVariables.p[3]);
	this->addProperty("rhoc", acadoVariables.p[4]);
	this->addProperty("dc", acadoVariables.p[5]);
	this->addProperty("AQ", acadoVariables.p[6]);
	this->addProperty("rA", acadoVariables.p[7]);
	this->addProperty("zT", acadoVariables.p[8]);
	this->addProperty("I1", acadoVariables.p[9]);
	this->addProperty("I31", acadoVariables.p[10]);
	this->addProperty("I2", acadoVariables.p[11]);
	this->addProperty("I3", acadoVariables.p[12]);
	this->addProperty("XIMU1", acadoVariables.p[13]);
	this->addProperty("XIMU2", acadoVariables.p[14]);
	this->addProperty("XIMU3", acadoVariables.p[15]);
	this->addProperty("LT", acadoVariables.p[16]);
	this->addProperty("RD", acadoVariables.p[17]);
	this->addProperty("PD", acadoVariables.p[18]);
	this->addProperty("YD", acadoVariables.p[19]);
	this->addProperty("CLA", acadoVariables.p[20]);
	this->addProperty("CLe", acadoVariables.p[21]);
	this->addProperty("CL0", acadoVariables.p[22]);
	this->addProperty("CDA", acadoVariables.p[23]);
	this->addProperty("CDA2", acadoVariables.p[24]);
	this->addProperty("CDB2", acadoVariables.p[25]);
	this->addProperty("CD0", acadoVariables.p[26]);
	this->addProperty("CRB", acadoVariables.p[27]);
	this->addProperty("CRAB", acadoVariables.p[28]);
	this->addProperty("CRr", acadoVariables.p[29]);
	this->addProperty("CPA", acadoVariables.p[30]);
	this->addProperty("CPe", acadoVariables.p[31]);
	this->addProperty("CP0", acadoVariables.p[32]);
	this->addProperty("CYB", acadoVariables.p[33]);
	this->addProperty("CYAB", acadoVariables.p[34]);
	this->addProperty("SPAN", acadoVariables.p[35]);
	this->addProperty("CHORD", acadoVariables.p[36]);
	this->addProperty("CL_scaling", acadoVariables.p[37]);
	this->addProperty("CD_scaling", acadoVariables.p[38]);
	// XXX Autogenerated code from MHE.cpp END

...
/// Include file with MHE weights
#include "autogenerated/mhe_weights.h"
/// Include file with steady state, computed with rawesome
#include "autogenerated/mhe_steady_state.h"

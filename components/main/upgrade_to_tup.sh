...
do
	...
	# Switch build system
	echo "Blowing away .gitignore files since they will be autogenerated..."
	find . -name ".gitignore" | xargs git rm --ignore-unmatch
	echo "Blowing away CMakeLists.txt files..."
	find . -name CMakeLists.txt | xargs git rm --ignore-unmatch

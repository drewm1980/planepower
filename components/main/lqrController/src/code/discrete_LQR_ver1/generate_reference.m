...
e1 = [0;1;0];e2 = [0;0;1];e3 = [1;0;0]; % From Séb
R = [e1 e2 e3].';                       % me and Séb use different parametrizations of R
...
!make equilibrium2
% !./equilibrium
eval(['!./equilibrium2 ',num2str(z),'     ',num2str(r),'     ',num2str(delta),'     ',num2str(ddelta)]);
cd ..
...
for k = 1:Nref
    ...
    X0k = [x y z  dx dy dz e11 e12 e13 e21 e22 e23 e31 e32 e33 w1 w2 w3 delta ddelta ur up].';

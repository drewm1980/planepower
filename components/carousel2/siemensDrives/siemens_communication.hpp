...
#define maxWinchShaftSpeed 1500.0 // RPM
...
#define maxWinchSpeed (maxWinchShaftSpeed/winchGearRatio*2.0*PI/60*winchDrumRadius) // m/s The speed of the surface of the drum
...
#define nominalCarouselSpeed (nominalCarouselShaftSpeed/carouselGearRatio*2.0*PI/60) // rad/s Nominal drive shaft rotation speed, a bit above 2*pi rad/s
#define maxCarouselSpeed (2*PI) // rad/s

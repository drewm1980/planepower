...
//
//! \struct tUIParameter
//! \brief Structure that contains a set of variables
//! that describes the properties of a parameter.
//
//*****************************************************************************
typedef struct
{
...
//*****************************************************************************
//
//! \struct tUIRealTimeData
//! \brief This structure contains a set of variables that describes the
//! properties of a real-time data item.
//
//*****************************************************************************
typedef struct
{
...
//*****************************************************************************
//
// TODO: Comment on this macros!!!
//
//*****************************************************************************

#define PARAM_TABLE_BEGIN \
	const tUIParameter g_sUIParameters[] = {
#define PARAM_TABLE_END \
	};
#define PARAM_ITEM( ID, Size, Min , Max, Step, Variable, Update ) \
	{ ID, Size, Min, Max, Step, (unsigned char *)&(Variable), Update }

#define RT_DATA_TABLE_BEGIN \
	const tUIRealTimeData g_sUIRealTimeData[] = {
#define RT_DATA_TABLE_END \
	};
#define RT_DATA_ITEM( ID, Size, Variable ) \
	{ ID, Size, (unsigned char *)&(Variable) }
/* V2
 * { ID, sizeof(Variable), (unsigned char *)&(Variable) }
 */

...
% subplot(122)
% hold on
% plot(X1_markers(:,1),X1_markers(:,2),'r.','MarkerSize',2)
% plot(X1_markers(:,3),X1_markers(:,4),'g.')
% plot(X1_markers(:,5),X1_markers(:,6),'b.')
...
% subplot(122)
% hold on
% plot(X1_markers(:,7),X1_markers(:,8),'r.','MarkerSize',2)
% plot(X1_markers(:,9),X1_markers(:,10),'g.')
% plot(X1_markers(:,11),X1_markers(:,12),'b.')

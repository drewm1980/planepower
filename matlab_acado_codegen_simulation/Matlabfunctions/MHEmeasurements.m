...
measurements = [Markers MHE.ddXref(MHE.t_index:MHE.Nref-1+MHE.t_index,:) MHE.Xref(MHE.t_index:MHE.Nref-1+MHE.t_index,MHE.state_index2) MHE.Uref(MHE.t_index:MHE.Nref-1+MHE.t_index,1:3)];
...
MHE.Scaling = [ones(1,12)*MHE.covariance_camera ones(1,3)*MHE.covariance_rotationalVelocity ones(1,3)*MHE.covariance_accelerations MHE.covariance_delta ones(1,2)*MHE.covariance_controlSurfaces MHE.covariance_controls ones(1,2)*MHE.covariance_dddelta];

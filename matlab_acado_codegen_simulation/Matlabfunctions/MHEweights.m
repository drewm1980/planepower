...
MHE.Q = diag([1/MHE.covariance_controls^2, ones(1,2)/MHE.covariance_dddelta^2]);
MHE.R = diag([ones(1,12)/MHE.covariance_camera^2, ones(1,3)/MHE.covariance_rotationalVelocity^2, ones(1,3)/MHE.covariance_accelerations^2, 1/MHE.covariance_delta^2, ones(1,2)/MHE.covariance_controlSurfaces^2]);
...
MHE.Qend = diag([ones(1,3)/MHE.covariance_rotationalVelocity^2, ones(1,3)/MHE.covariance_accelerations^2, 1/MHE.covariance_delta^2, ones(1,2)/MHE.covariance_controlSurfaces^2]);
